...
class LatentGraphSDE(torchsde.SDEIto):
    ...
    def __init__(self, in_net, drift_net, out_net, theta=1.0, mu=0.0, sigma=1.0, adaptive=True, method="srk", rtol =0.01, atol = 0.01, sde_output_dim=64, t0=0, t1=1.0, device=None, opt=None):
