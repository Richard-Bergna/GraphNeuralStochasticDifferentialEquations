  ...
  def forward(self, x, pos_encoding=None):
    ...
    if self.training  and self.odeblock.nreg > 0:
      if self.opt['use_stochastic_grand']:
        print("self.opt['use_stochastic_grand']",  self.opt['use_stochastic_grand'])
    ...
    # print("00000 aug_y0.shape", aug_y0.shape)
    bm = self._init_brownian_motion(batch_size, aug_y0)
    
    # print("1"*50)
    # print("self.t0, self.t1/10", self.t0, self.t1/10)
    # print("z.shape", z.shape)
    # print("aug_y0.shape", aug_y0.shape)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--time', type=float, default=0.01, help='End time of ODE integrator.')
