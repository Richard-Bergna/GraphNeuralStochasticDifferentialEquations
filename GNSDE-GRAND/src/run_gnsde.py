...
def main(cmd_opt):
  ...
  for entropy_threshold in entropy_thresholds:
    ...
    _, _, test_acc = this_test(best_model, data, pos_encoding, opt, entropy_threshold, n_samples=10)
...
if __name__ == '__main__':
  ...
  model_sde_name = 'GNSDE-GRAND'
  if opt['planetoid_split'] or opt['use_80_10_10_split']:
    model_sde_name = 'GNSDE-GRAND_planetoid_split'
  ...
  save_results(all_accuracies, model_sde_name, entropy_results_path)
